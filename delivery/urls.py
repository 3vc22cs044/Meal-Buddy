...
urlpatterns = [
    ...
    path('increase_cart_item/<int:item_id>/<str:username>', views.increase_cart_item, name='increase_cart_item'),
    path('decrease_cart_item/<int:item_id>/<str:username>', views.decrease_cart_item, name='decrease_cart_item'),
    ...
    path('cash_on_delivery/<str:username>/', views.cash_on_delivery, name='cash_on_delivery'),
